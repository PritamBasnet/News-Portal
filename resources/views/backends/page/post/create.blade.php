...
@section('content')
    <div class="Post_row">
        <div id="form-menu">
            ...
            <form action="{{ route('post.store') }}" class="Post_Form" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="slug" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter The Slug">
                </div>
                <?php
                    $menu = App\Models\menu::all();
                ?>
                <select name="cat_id" id="" class="Edit_select">
                    @isset($menu)
