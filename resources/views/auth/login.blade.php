...
<body>
    <form action="{{ route('auth.check') }}" class="LoginForm" method="POST">
        @csrf
        @if (Session('fail'))
        ...
        <a href="/auth/register" class="Register_Page">I dont have an Account? Create New.</a>
    </form>
</body>
